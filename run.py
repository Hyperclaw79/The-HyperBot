...
def main():
    if not sys.version_info >= (3, 5):
        ...
        # Maybe I should check for if the current dir is the Hyperbot folder, just in case
    ...
    while tryagain:
        ...
        try:
            ...
            if hasattr(e, '__module__') and e.__module__ == 'Hyperbot.exceptions':
